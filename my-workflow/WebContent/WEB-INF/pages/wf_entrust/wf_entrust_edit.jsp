...
<input type="hidden" id="strids" name="strids" value="${strids}">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="88%"><font
				face="Arial, Helvetica, sans-serif"><b>委托设置->编辑</b>
			</font>
			</td>
					...
					<table border="0" cellspacing="0" cellpadding="1" align="center" width="600px">
						...
						<tr>
							...
							<td size="10" height="35px"><input type="text"
								name="BeginTime" id="BeginTime"  value ="2018-07-05 22:00" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH'});"/></td>
							<td height="35px" align="right"><b><font color="0E2F72">结束时间：</font>
							</b>
							</td>
							<td size="10" height="35px"><input type="text" value ="2018-08-05 22:00" style = "width:165px"name=EndTime id="EndTime" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH'});"/></td>
					</table>
				</td>
			</tr>
			<tr>
				...
				<table border="1" cellspacing="0" cellpadding="2" align="left"	width="300px">
					...
					<tr>				
						<td width="50px" class="tableTitle"><input type="checkbox" name='checkOrder' checked /></td>
