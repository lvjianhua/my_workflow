...
<script type="text/javascript">
    window.onload = function () {
        ...
        function openNew(id, name) {
            ...
            tagMenu.id = "p" + id;
            tagMenu.innerHTML = name + "   " + "<img src='${contextPath}/resources/images/050.png' style='vertical-align:middle;width:15px;height:14px'/>";
            //标签点击事件
...
<div id="leftMenu">
<ul>
<li><a href="${contextPath}/wfTypeList" target="content1">工作流设置</a></li>
<li><a href="${contextPath}/wfTaskList" target="content2">工作流查看</a></li>
<li><a href="${contextPath}/getWfEntrustList" target="content3">工作流委托</a></li>
<li><a href="${contextPath}/getNewWfTask" target="content4">工作流发起</a></li>
</ul>
</div>
<div id="content">
<div id="welcome" class="content" style="display:block;">
  <div align="center">
    <p> </p>
    <p><strong>${login.userName}:欢迎使用用户管理系统！</strong></p>
    <p> </p>
    </div>
</div>
...
<div id="footer">lv jian hua workflow</div>
</body>
</html>